    ...
    return (ready && _filter && ids ?
        <MDBRow style={style} className={className}>
            ...
            <MDBCol style={{ padding: 0 + 'em' }} style={{ marginLeft: "1%" }}>
                ...
                <MDBCol className='p-0' style={{ marginRight: 0 + 'em', marginTop: -9 + 'px', paddingLeft: 1 + 'em' }}>
                    {
                        _filter.map((f, i) => {
                ...
                <MDBCol style={{ marginLeft: "1%" }}>
                    ...
                    <div className="d-flex justify-content-between " style={{ marginLeft: "0%" }} >
                        ...
                        <input ref={searchInputRef}
                            ...
                            type="text" id={`${ids[0]}__input`} autoComplete="off" placeholder="Recherche..." className="form-control float-right " style={{ width: "55%" }} />
                    </div>
