...
const ModalML = ({ toggle2, ML_Tags_Function,  modelMl, Listes_Ml, handleListeMLClick, ML_Membre }) => {
    ...
    const [errors, setErrors] = useState({ ML_Tags_var: '' })
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        ML_Tags_Function(ML_Tags_var,showTAGS_ML)
        //console.log("ML_Tags_var", ML_Tags_var)
  
    }, [ML_Tags_var,showTAGS_ML])
            ...
            <MDBModalBody>
                ...
                <MDBRow>
                    ...
                    {showTAGS_ML == true ? (<MDBCol size="12">
                        ...
                        <label htmlFor="defaultFormLoginEmailEx" className="grey-text">
                            Mot clé d'une nouvelle liste measures
                        </label>
                        ...
                        {errors.ML_Tags_var.length > 0 &&
              <span className='text-danger' style={{ fontSize: '12px' }}>{errors.ML_Tags_var}</span>}
