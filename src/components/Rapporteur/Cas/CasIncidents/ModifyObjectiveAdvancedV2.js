...
const ModifyObjectiveAdvanced = ({ datafromcasincidents ,valueajoutertabcallback,dataEnergyMeasure,toggleFilterMesure3,modalFilterMesure3,toggleFilterMesure5,modalFilterMesure5,toggleFilterMesure7,modalFilterMesure7,funModale }) => {
    ...
    useEffect(() => {
        ...
        if(datafromcasincidents[5].length!=0){
          ...
          for (var i=0;i<datafromcasincidents[5].length;i++){
      
              var keyword= datafromcasincidents[5][i].keyword
              var valeur= datafromcasincidents[5][i].valeur
