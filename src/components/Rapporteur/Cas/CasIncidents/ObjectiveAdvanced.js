...
class ObjectiveAdvanced extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            dataEnergyMeasure: this.props.datafromcasincidents[5],
            U_Compteur:this.props.datafromcasincidents[6],
            supprimertemp: [],
            modificationtemp: [],
            datamodifier: [],
            ajoutertap: [],
            ...
            .then(
                (result) => {
                    if (result.data !== null) {
                        ...
                        console.log('Get OBJECTIVE from database', result.data)
                        ...
                        if (/*  prevState.listobjectivefromDB !== this.state.listobjectivefromDB && */
                            this.state.listobjectivefromDB.length > 0) {
                            //m_name
            ...
            columns: [
...

                {
                    ...
                    cellClick: function (e, cell) {
                        ...
                        cell.getData();
                        console.log("kkk",cell.getData())
                        console.log("kkk",cell.getData().user_value)
    ...
    ajoutTab() {
        ...
        var valeurDev = ''
        console.log(this.state.haut, this.state.bas, this.state.totale_Dans, this.state.dans)
        if (this.state.haut == "" && this.state.bas == "" && this.state.totale_Dans == "") {
            ...
            if (this.state.totale_Dans != "") {
                console.log(this.state.totale_Dans + "ensembleeeeeeeeeeee")
                const keyword = this.state.keyword;
                const operateur = this.state.operateur;
                ...
                //     valeurDev = [{ "type": "r", "content": this.state.dans }]
                // }else{
    ...
    toggle = nr => () => {
        ...
        if (nr === 3 || nr === 7 || nr === 5) {
            console.log("--------------------------------------------------------->", this.state.incidentselectedwithoutlive)
            ...
            if (this.state.modal4 === true || this.state.modal6 === true || this.state.modal8 === true) {
                this.state.valuetomesure = ''
            }
    ...
    componentDidUpdate() {
        ...
        console.log("this.state.supprimertemp",this.state.supprimertemp)
    ...
    btnAjouterDans() {
        if (this.state.dans == "") {
            ...
            console.log(this.state.jsondans)
    ...
    outSelectedMesure3 = (json) => {
        console.log("json Object", json)
        console.log('json----------------->', json, { "m_code": json.EMNCode, "m_name": json.measure_Label, "measure_ID": json.measure_ID })
        //MeasureGetObject({"m_code": json.EMNCode, "m_name": json.measure_Label,"measure_ID":json.measure_ID})
        this.setState({ MeasureGetObject: [{ "m_code": json.EMNCode, "m_name": json.measure_Label, "measure_ID": json.measure_ID }] })
    }

    outSelectedMesure5 = (json) => {
        console.log("json Object", json)
        this.setState({ MeasureGetObject: [{ "m_code": json.EMNCode, "m_name": json.measure_Label, "measure_ID": json.measure_ID }] })
    }
    outSelectedMesure7 = (json) => {
        console.log("json Object", json)
        this.setState({ MeasureGetObject: [{ "m_code": json.EMNCode, "m_name": json.measure_Label, "measure_ID": json.measure_ID }] })
    }
    ...
    toggleFilterMesure3 = () => {
        console.log("---",this.state.dataEnergyMeasure)
        console.log("---",this.state.U_Compteur)
        if(this.state.U_Compteur.length!=0){
        this.setState({ modalFilterMesure3: !this.state.modalFilterMesure3 })
    }else{
        Swal.fire({
            toast: true,
